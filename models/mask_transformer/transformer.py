...
class MaskTransformer(nn.Module):
    ...
    def forward(self, ids, y, m_lens, pad_mask):
        '''
        :param ids: (b, n)
        ...
        Prepare mask
        '''
        # rand_mask_probs: generate proportion of mask for each sample in the batch.
        ...
        # If mask_mid is true in this position, return the mask_id, else return the original token.
        # TODO: add self.mask_feature as a learnable parameter
        x_emb = torch.where(mask_mid, self.mask_feature, x_ids)
