...
class Text2MotionDataset(data.Dataset):
    def __init__(self, dataset_name, split, w_vectorizer, feat_bias = 5, max_text_len = 20, unit_length = 4, data_root = None):
...
def DATALoader(dataset_name, split,
    ...
    val_loader = torch.utils.data.DataLoader(Text2MotionDataset(dataset_name, split, w_vectorizer, unit_length=unit_length, data_root=data_root),
                                              batch_size,
                                              shuffle = True,
