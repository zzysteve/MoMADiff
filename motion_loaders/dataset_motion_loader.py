...
def get_dataset_motion_loader(opt_path, batch_size, fname, device, shuffle=True):
...
def get_dataset_motion_loader_for_crossdata(opt_path, batch_size, fname, device, data_root):
    opt = get_opt(opt_path, device)
